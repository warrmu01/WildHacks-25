(() => {
  ((a, b) => {
    ...
    let a = {
      ...
      startTimer: (b, c) => {
        if ((b || (b = a.currentPageName), void 0 === a.startStopTimes[b]))
          a.startStopTimes[b] = [];
        else {
      ...
      resetAllRecordedPageTimes: () => {
        let b = Object.keys(a.startStopTimes);
        for (let c = 0; c < b.length; c++) a.resetRecordedPageTime(b[c]);
      },
      ...
      callWhenUserLeaves: (b, c) => {
        a.userLeftCallbacks.push({ callback: b, numberOfTimesToInvoke: c });
      },
      callWhenUserReturns: (b, c) => {
        a.userReturnCallbacks.push({ callback: b, numberOfTimesToInvoke: c });
      },
      ...
      checkIdleState: () => {
        ...
        !1 === a.isUserCurrentlyIdle && a.currentIdleTimeMs > a.idleTimeoutMs
          ? ((a.isUserCurrentlyIdle = !0), a.triggerUserHasLeftPageOrGoneIdle())
      ...
      listenForVisibilityEvents: (b, c) => {
        b && a.listenForUserLeavesOrReturnsEvents(), c && a.listForIdleEvents();
      },
          ...
          ? "undefined" == typeof document.mozHidden
            ? "undefined" == typeof document.msHidden
              ? "undefined" != typeof document.webkitHidden &&
                ...
                (a.visibilityChangeEventName = "webkitvisibilitychange"))
              : ((a.hiddenPropName = "msHidden"),
                (a.visibilityChangeEventName = "msvisibilitychange"))
          ...
          try {
            (a.websocket = new WebSocket(c)),
              ...
              (a.websocket.onerror = (a) => {
                console &&
                  console.log("Error occurred in websocket connection: " + a);
              }),
            ...
            console &&
              console.error("Failed to connect to websocket host.  Error:" + a);
          }
        }
      },
      websocketSend: (b) => {
